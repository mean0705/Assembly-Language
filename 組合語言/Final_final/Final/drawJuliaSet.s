...
loop1:
    ...
    bge end1        @ if r9(x) >= r4(width), for 1 end

    /* below are loop 2. */
    mov r5, #0      @ y = 0
loop2:
    cmp r5, #height @ cmp y with height
    bge end2        @ if r10(y) >= r5(height), for 2 end
...
end1:
    ...
    mov r0, r11
    mov r1, r11
    cmphs r0, r0, lsl r0  @ hs( c set )
    sbcs r11, r0, r1 @ r11 = r0 - r1 + c -1
    cmp r0, r11
    movne r11, r1    @ eq( z not set )
    moveq r11, r0    @ eq( z set )
