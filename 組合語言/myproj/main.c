...
int main()
{
    ...
    extern char name1[15] ;
    extern char name2[15] ;
    extern char name3[15] ;
    extern void myjulia( int a, int b, int c, int d, int16_t frame[FRAME_HEIGHT][FRAME_WIDTH] ) ;
	...
	else
	{
		for( cY=400 ; cY>=min_cY; cY = cY + cY_step ) {
			...
			myjulia( cX, cY, FRAME_WIDTH, FRAME_HEIGHT, frame );
